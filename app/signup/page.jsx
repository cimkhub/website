...
export default function SignUp() {
  ...
  return (
    <div className="flex flex-col min-h-[100dvh]">
                ...
                <div className="mx-auto max-w-md space-y-4">
                  <div id="mc_embed_shell">
                    ...
                    <div id="mc_embed_signup">
                      <form
                        action="https://cimk.us1.list-manage.com/subscribe/post?u=59238c959adf4c9271a216a49&amp;id=db1377afed&amp;f_id=0039f8e5f0"
                        method="post"
                      ...
                      >
                        <div id="mc_embed_signup_scroll">
                          ...
                          <div style={{ position: 'absolute', left: '-5000px' }} aria-hidden="true">
                            <input type="text" name="b_59238c959adf4c9271a216a49_db1377afed" tabIndex={-1} defaultValue="" />
                          </div>
      ...
      <footer className="bg-white p-6 md:py-6 w-full text-black text-center">
        © APIarist 2024
      </footer>
    </div>
  );
